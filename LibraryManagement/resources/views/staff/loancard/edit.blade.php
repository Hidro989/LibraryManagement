                                    ...
                                    <div class="outer">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-daterange input-group">
                                                <input type="date" class="form-control" placeholder="Start Date" name="dateStart" value="{{$loancard->dateStart}}">
                                                <input type="date" class="form-control" placeholder="End Date" name="dateEnd" value="{{$loancard->dateEnd}}">
                                            </div>
                                        </div>
