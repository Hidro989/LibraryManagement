                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Đọc giả</h4>
                                    <a href="{{route('reader.create')}}" class="btn btn-primary">Thêm đọc giả</a>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Quản lý đọc giả</a></li>
                                            <li class="breadcrumb-item active">Đọc giả</li>
                                        </ol>
                                    </div>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline font-size-20 contact-links mb-0">
                                                                <li class="list-inline-item px-2">
                                                                    ...
                                                                    <a href="{{url('/reader/'.$reader->cmnd)}}" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                ...
                                                                <form action="{{route('reader.destroy', $reader->cmnd)}}" method="POST" data-toggle="tooltip" data-placement="top" title="Remove" class="d-inline">
                                                                    @method('DELETE')
                                                                    @csrf
