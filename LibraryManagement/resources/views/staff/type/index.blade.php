                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="{{route('book.create')}}" class="btn btn-primary">Thêm thể loại</a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap table-hover">
                                                <thead class="thead-light">
                                                    <tr>
                                                        <th scope="col">ID</th>
                                                        <th scope="col" colspan="2">Tên thể loại</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <a href="#" class="badge badge-soft-primary font-size-11 m-1">{{$book->idTypeBook}}</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            {{$book->author}}
